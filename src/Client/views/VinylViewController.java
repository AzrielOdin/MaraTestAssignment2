...
public class VinylViewController {
    ...
    @FXML
    private TableView<VinylDisplay> vinylTable;
    @FXML
    private TextArea logTextArea;
    @FXML
    private TableColumn<VinylDisplay, String> titleColumn;
    @FXML
    private TableColumn<VinylDisplay, String> artistColumn;
    @FXML
    private TableColumn<VinylDisplay, Integer> releaseYearColumn;
    @FXML
    private TableColumn<VinylDisplay, String> stateColumn;
    @FXML
    private TableColumn<VinylDisplay, String> reservedByColumn;
    @FXML
    private TableColumn<VinylDisplay, String> borrowedByColumn;
    @FXML
    private TableColumn<VinylDisplay, String> markedForRemovalColumn;
    @FXML
    ...
    public void onMarkForRemovalButtonPress() {
        runTask(
                currentUser.getName() + " [" + currentUser.getId() + "] marked vinyl for removal",
                () -> {
                    Vinyl vinyl = getSelectedVinyl();
                    if (vinyl != null) {
    ...
    private void runTask(String actionDescriptionSupplier, Runnable backgroundAction) {
        VinylDisplay selectedDisplay = vinylTable.getSelectionModel().getSelectedItem();
        ...
        Task<Void> task = new Task<>() {
            ...
            @Override
            protected Void call() {
                // compute the description inside the worker thread
                actionDescription = actionDescriptionSupplier;
            ...
            protected void succeeded() {
                ...
                updateUI();
                restoreSelection(selectedDisplay);
            }
            ...
            private void restoreSelection(VinylDisplay toSelect) {
                if (toSelect == null) return;
                for (VinylDisplay item : vinylTable.getItems()) {
                    if (item.getId() == toSelect.getId()) {
        ...
        Thread t = new Thread(task, "VinylActionTask");
        t.start();
    }
